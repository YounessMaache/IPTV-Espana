        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><a href="/aprende" className="hover:text-primary transition-colors">{t.footer.learn}</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><a href="#" className="hover:text-primary transition-colors">{t.footer.iptvSpain}</a></li>
              <li><a href="#" className="hover:text-primary transition-colors">{t.footer.resellerProgram}</a></li>
              <li><a href="#" className="hover:text-primary transition-colors">{t.footer.installGuide}</a></li>
              <li><a href="#" className="hover:text-primary transition-colors">{t.footer.support}</a></li>
              <li><a href="/test" className="hover:text-primary transition-colors">{t.footer.test}</a></li>
            </ul>
          </div>
